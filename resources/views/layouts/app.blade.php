...
<body class="bg-slate-50 text-slate-900">
    <nav class="glass sticky top-8 z-40 mx-4 mt-4 px-6 py-4 rounded-2xl border border-white/20 shadow-lg flex justify-between items-center max-w-7xl md:mx-auto">
        ...
        <div class="hidden md:flex gap-8 font-medium">
            <a href="{{ route('katalog') }}" class="text-indigo-600">Katalog</a>
            ...
            <a href="{{ route('admin.dashboard') }}" class="hover:text-indigo-600 transition font-bold text-indigo-800">Panel Admin</a>
        </div>
    </nav>
    ...
    <footer class="bg-indigo-900 text-indigo-100 py-20 px-6 mt-20">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            <div class="space-y-4 col-span-2">
                ...
                <p class="max-w-xs text-indigo-300">Platform reservasi tiket event online terbaik.</p>
            </div>
            <div>
