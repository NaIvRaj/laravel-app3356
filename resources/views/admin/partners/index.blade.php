...
<div class="space-y-8">
    ...
    <div class="flex justify-between items-center gap-4">
        <form action="{{ route('partners.index') }}" method="GET" class="flex gap-2 w-full md:w-96">
            ...
            @if(request('search'))
                    <a href="{{ route('partners.index') }}" class="px-4 py-2 bg-slate-200 text-slate-700 rounded-xl font-bold flex items-center justify-center hover:bg-slate-300 transition">
                        Reset
                    </a>
                @endif
        </form>
