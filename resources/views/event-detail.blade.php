    ...
    <div class="lg:col-span-2 space-y-12">
        <div class="space-y-4">
            <span
                ...
                Festival</span>
            <h1 class="text-4xl md:text-5xl font-black leading-tight">Jazz Night 2026: A Celebration of Rhythm &
                Melody</h1>
            <div class="flex flex-wrap gap-6 text-slate-500 font-medium">
                <div class="flex items-center gap-2">
                    ...
                    <span>Saturday, 16 Nov 2026</span>
                </div>
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="prose prose-slate max-w-none">
            ...
            <p class="text-lg text-slate-600 leading-relaxed">
                Nikmati malam yang tak terlupakan dengan alunan jazz dari musisi internasional. Jazz Night 2026
