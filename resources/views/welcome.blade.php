...
<section class="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12">
    <div class="flex-1 space-y-8">
        ...
        <p class="text-lg text-slate-500 max-w-lg leading-relaxed">Dari konser musik hingga workshop teknologi, semua ada di genggamanmu.</p>
...
<section id="events" class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden">
            ...
            <div class="p-6">
                <h3 class="text-xl font-bold mb-2">Jazz Night 2026</h3>
        ...
        <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden">
            ...
            <div class="p-6">
                <h3 class="text-xl font-bold mb-2">AI & Future Tech</h3>
                <div class="flex justify-between items-center pt-4 border-t">
        ...
        <div class="group bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden">
            <div class="relative overflow-hidden aspect-[3/4]">
                <img src="{{ asset('assets/hackaton.png') }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
            </div>
            <div class="p-6">
                <h3 class="text-xl font-bold mb-2">Hackaton Unleash</h3>
                <div class="flex justify-between items-center pt-4 border-t">
